...
```
#### I didn't really analyze what it does aside from the fact that it is recursive, but I do know that I was gonna be able to use it for solving the challenge.
